...
| Week 7 | Dashboards & Maps with bqplot | 1. VAD Ch. 8: Arrange Spatial Data <br> 2. VAD Ch. 11: Manipulate View <br> 3. <a href="https://serialmentor.com/dataviz/geospatial-data.html">FDV, Ch. 15: Visualizing geospatial data</a>
| Week 8 | More with maps - bqplot, cartopy, ipyleaflet, geopandas | 1. VAD Ch. 8: Arrange Spatial Data <br> 2. <a href="https://serialmentor.com/dataviz/geospatial-data.html">FDV, Ch. 15: Visualizing geospatial data</a> <br> 3. <a href="https://scitools.org.uk/cartopy/docs/latest/">Cartopy docs</a>; <a href="https://ipyleaflet.readthedocs.io/en/latest/">ipyleaflet docs</a>; <a href="https://geopandas.org/">Geopandas Docs</a>
...
| Week 14 | Holiday!
| Week 15 | Scientific visualization <br> <br> Guest lecture about scientific & cinematic viz from <a href="http://avl.ncsa.illinois.edu/">AVL</a> | 1. <a href="https://yt-project.org/">yt docs</a> <br> 2. <a href="https://yt-project.org/doc/visualizing/volume_rendering.html">yt Volume Rendering Tutorial</a>
| Week 16 | Network Viz & Word cloud Viz | 1. VAD Ch. 9: Arrange Networks and Trees
